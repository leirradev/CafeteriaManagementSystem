...
?>
	...
	<head>
		...
		<script type = "text/javascript" src="js/dailytransactionsearch.js"></script>
  ...
  background-color: #ffff99;
	...
	<body onload="startTime(),ini()">
		...
		<div id="productcontainer" style="position:relative;">
			...
			<div id="editcontent">
				<span id="addtitle">DAILY TRANSACTION RECORDS</span></br></br>
				<div id="search">
					Search:
					<select id="seacat">
				...
				<table id="tablecontainer">
					...
					<?php
						...
						$sql="SELECT * FROM transaction where status = 'CLAIM' and date = '{$date}'  order by id desc";
						...
						<tr><td colspan="10" align="center"><?php echo "<a href=dailytransactionreport.php?total=".$total."&date=".$date."><button class='form-control'>Print</button></a></td></tr>";?><?php
					?>
				</table>
