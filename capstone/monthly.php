...
?>
	...
	<head>
		...
		<script type = "text/javascript" src="js/monthlytransactionsearch.js"></script>
  ...
  background-color: #ffff99;
	...
	<body onload="startTime(),ini()">
		...
		<div id="productcontainer" style="position:relative;">
			...
			<div id="editcontent">
				<span id="addtitle">MONTHLY TRANSACTION RECORDS</span></br></br>
				<div id="search">
					Search:
					<select id="seacat">
				...
				<table id="tablecontainer">
					...
					<?php
						...
						<tr><td colspan="10" align="center"><?php echo "<a href=monthlytransactionreport.php?total=".$total."><button class='form-control'>Print</button></a></td></tr>";?><?php
					?>
				</table>
