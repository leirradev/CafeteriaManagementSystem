  ...
  background-color: #ffff99;
	...
	<body onload="startTime(),ini()">
		...
		<div id="productcontainer" style="position:relative;">
			...
			<div id="editcontent">
				<span id="addtitle">TRANSACTION RECORDS</span></br></br>
				<div id="search">
					Search:
					<select id="seacat">
				...
				<table id="tablecontainer">
					...
					<?php
						$sql="SELECT * FROM transaction where status = 'CLAIM' order by id desc";
						...
						<tr><td colspan="10" align="center"><?php echo "<a href=transactionreport.php?total=".$total."><button class='form-control'>Print</button></a></td></tr>";?><?php
					?>
				</table>
