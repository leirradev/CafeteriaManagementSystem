...
<?php		
	...
	<tr><td colspan="10" align="center"><?php echo "<a href=yearlytransactionreport1.php?total=".$total."&id=".$name."><button class='form-control'>Print</button></a></td></tr>";?><?php
	}
	else if($cate == "category"){
	?><tr><td colspan="10" align="center"><?php echo "Total: Php ".$total.""; ?></td></tr>
	<tr><td colspan="10" align="center"><?php echo "<a href=yearlytransactionreport2.php?total=".$total."&user=".$name."><button class='form-control'>Print</button></a></td></tr>";?><?php
	}
	else if($cate == "product"){
	?><tr><td colspan="10" align="center"><?php echo "Total: Php ".$total.""; ?></td></tr>
	<tr><td colspan="10" align="center"><?php echo "<a href=yearlytransactionreport3.php?total=".$total."&product=".$name.">Print</a></td></tr>";?><?php
	}
	else if($cate == "date"){
	?><tr><td colspan="10" align="center"><?php echo "Total: Php ".$total.""; ?></td></tr>
	<tr><td colspan="10" align="center"><?php echo "<a href=yearlytransactionreport4.php?total=".$total."&date=".$name.">Print</a></td></tr>";?><?php
	}
?>
</table>