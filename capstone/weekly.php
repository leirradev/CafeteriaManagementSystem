...
?>
	...
	<head>
		...
		<script type = "text/javascript" src="js/weeklytransactionsearch.js"></script>
  ...
  background-color: #ffff99;
	...
	<body onload="startTime(),ini()">
		...
		<div id="productcontainer" style="position:relative;">
			...
			<div id="editcontent">
				<span id="addtitle">WEEKLY TRANSACTION RECORDS</span></br></br>
				<div id="search">
					Search:
					<select id="seacat">
			...
			$end = getDay('Sunday')->format('m/d/Y');
						$sql="SELECT * from transaction WHERE status = 'CLAIM' and date BETWEEN '{$begin}' AND '{$end}' order by id desc";
						...
						<tr><td colspan="10" align="center"><?php echo "<a href=weeklytransactionreport.php?total=".$total."><button class='form-control'>Print</button></a></td></tr>";?><?php
					?>
				</table>
